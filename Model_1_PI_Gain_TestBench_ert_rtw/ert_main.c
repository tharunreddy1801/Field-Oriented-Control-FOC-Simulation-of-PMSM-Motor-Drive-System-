...
#include "Model_1_PI_Gain_TestBench.h" /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  Model_1_PI_Gain_TestBench_step0();
  ...
  if (eventFlags[1]) {
    ...
    Model_1_PI_Gain_TestBench_step1();
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  Model_1_PI_Gain_TestBench_initialize();
